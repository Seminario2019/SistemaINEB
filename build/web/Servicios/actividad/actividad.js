 ...
 */
     ...
     app.controller("actividad", function($scope,$http,serveData,$state,$timeout) {
   ...
   $scope.lista_asignaturass = function(){       
        ...
        $scope.lista_tactividades = function(  ){          
                $("#modal_tactividad").modal();
	};
    ...
    $scope.lista_actividad = function(){       
      ...
      $scope.seleccion_actividad = function(data){
          ...
          $scope.datos.id_asignatura  = data.id_asignatura;
          $scope.datos.asignatura = data.asignatura;
          $scope.datos.id_tactividad  = data.id_tactividad;
          $scope.datos.tactividad = data.tactividad;
    ...
    $("#modal_guardar").modal('hide');  swal("¡Faltan Datos!", "Por favor verificar", "warning");
     ...
     $scope.esnumero = function (dato) {
        ...
        $scope.seleccion_asinatura = function(data){
          $scope.datos.id_asignatura  = data.id;
          $scope.datos.asignatura = data.nombre;
        }
        
        $scope.seleccion_tactividad = function(data){
          $scope.datos.id_tactividad = data.id;
          $scope.datos.tactividad = data.nombre;
        }
