 ...
 * @author usuario
 */
@WebServlet(name = "nota_guadaEdit", urlPatterns = {"/nota_guadaEdit"})
public class nota_guadaEdit extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
     ...
     notas_CRUD crud = new notas_CRUD();
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println(crud.GuardaEdit(id,id_actividad,id_alumno,nota,periodo));
        }
