...
import java.util.*;
public class NumerosLetras extends JRDefaultScriptlet {
 private int flag;
 public int numero;
 ...
 public NumerosLetras() throws JRScriptletException{
 numero = 0;
 flag=0;
 }
 public NumerosLetras(int n) throws JRScriptletException{
 numero = n;
 flag=0;
 }
