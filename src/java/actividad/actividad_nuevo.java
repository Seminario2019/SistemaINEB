 ...
 * @author usuario
 */
@WebServlet(name = "actividad_nuevo", urlPatterns = {"/actividad_nuevo"})
public class actividad_nuevo extends HttpServlet {
...
String datos[] = null ;
      ...
      actividad_CRUD crud = new actividad_CRUD();
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println(crud.nuevo(id,id_tactividad,id_asignatura));
        }
        
                } catch (JSONException ex) {
            java.util.logging.Logger.getLogger(actividad_nuevo.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
