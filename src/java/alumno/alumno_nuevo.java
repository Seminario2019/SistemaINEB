 ...
 * @author usuario
 */
@WebServlet(name = "alumno_nuevo", urlPatterns = {"/alumno_nuevo"})
public class alumno_nuevo extends HttpServlet {
...
String datos[] = null ;
        ...
        try {
            ...
            String correlativo  = jObj.getJSONObject("datos").getString("correlativo");
      ...
      alumno_CRUD crud = new alumno_CRUD();
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println(crud.nuevo(correlativo,codigo,pnombre,snombre,papellido,sapellido,nfecha));
        }
        
                } catch (JSONException ex) {
            java.util.logging.Logger.getLogger(alumno_nuevo.class.getName()).log(Level.SEVERE, null, ex);
        }
